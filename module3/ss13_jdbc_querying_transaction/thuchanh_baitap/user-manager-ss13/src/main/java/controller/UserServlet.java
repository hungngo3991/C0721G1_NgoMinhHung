...
//        List<User> userList = userService.selectAllUsers();
        List<User> userList = userService.selectAllUsersBySP();
...
//        userService.insertUser(userCreate);
        userService.insertUserStore(userCreate);
...
//        userService.updateUser(userUpdate);
        userService.updateUserBySP(userUpdate);
...
//        userService.deleteUser(id);
    ...
    private void addUserPermision(HttpServletRequest request, HttpServletResponse response) {
        ...
        User user = new User("Nam", "nam@gmail.com", "Viet Nam");
